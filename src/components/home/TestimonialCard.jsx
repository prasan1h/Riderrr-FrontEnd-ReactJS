  ...
  return (
    <>
      <div className="swiper-slide flex justify-center items-center">
        <figure className="relative rounded-2xl bg-primary p-6">
          <svg
            aria-hidden="true"
            width="105"
            height="78"
          ...
          <figcaption className="relative mt-1 flex items-center justify-between border-t border-slate-100 pt-3">
            <div>

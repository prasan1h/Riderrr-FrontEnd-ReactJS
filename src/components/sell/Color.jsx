...
function Color({ setVehicleDetails, setStep}) {
    ...
    <div className="px-20 py-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
        ...
        {colors.map((color) => (
          <div
            key={color.name}
            className="border rounded-xl p-6 flex flex-col items-center cursor-pointer hover:bg-gray-100 hover:shadow-md transition"
